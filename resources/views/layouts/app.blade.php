        ...
        <div>
            ...
            <nav>
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin.inventory.dashboard') }}" class="{{ request()->routeIs('admin.inventory.*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="#" class="{{ request()->routeIs('admin.report') ? 'active' : '' }}" onclick="showComingSoon(event, 'Reports')">
